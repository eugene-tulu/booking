...
export function ContactSection(): JSX.Element {
  return (
    <section
      id="contact"
      className="w-full max-w-[2560px] bg-deepEmerald bg-[url('/images/svg/radial-background.svg')] bg-cover bg-center bg-no-repeat"
    >
      <div
      ...
      >
        <div className="mb-[48px] flex items-center justify-center md:grid md:grid-cols-2 md:gap-[32px] lg:gap-[48px] w-1400:mb-8">
            <h2 className="bg-gradient-to-br from-whiteGradientFrom to-whiteGradientTo bg-clip-text text-center font-[BalooTamma] font-bold leading-[1.05] text-transparent md:col-start-2 md:col-end-3">
              <span className="whitespace-nowrap text-[clamp(36px,11vw,80px)] md:text-[5.8vw] w-1400:text-[80px]">
                Get In Touch
              </span>
              <br />
              <span className="text-[clamp(32px,8.1vw,59px)] md:whitespace-nowrap md:text-[4.3vw] w-1400:text-[59px]">
                Book Your Session
              </span>
            </h2>
        </div>
        ...
        <div className="flex flex-col justify-center gap-[12vw] md:grid md:grid-cols-2 md:gap-[32px] lg:gap-[48px]">
          <div className="flex h-[300px] items-center justify-center px-[4%] sm:px-[8%] md:mt-6 md:h-[364px] md:px-0 w-1400:h-[450px]">
            <GoogleMapWidget />
          </div>
