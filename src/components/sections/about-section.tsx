      ...
      <div className="mx-auto mt-12 flex w-full max-w-[1440px] flex-col-reverse overflow-hidden px-5 md:my-8 md:grid md:grid-cols-2 md:px-6 lg:px-7">
        <div className="flex items-center justify-center">
          <img
            ...
            alt="Physiotherapist consulting with patient"
          />
        </div>

        <div className="flex flex-col items-center gap-8 md:gap-6">
          <h2 className="w-[90%] bg-gradient-to-br from-emeraldGradientFrom to-emeraldGradientTo bg-clip-text text-center font-[BalooTamma] font-bold leading-[1.05] md:text-start">
