  ...
  return (
    <Card className="rounded-xl border-none bg-transparent p-4 pr-[18%] shadow-none md:mb-0 md:pr-[12%] lg:pr-[2%] lg:hover:scale-[1.02] lg:hover:shadow-xl">
      <CardHeader className="flex flex-row gap-4">
        <Icons.plaster className="hidden min-h-[32px] min-w-[32px] text-sageText md:inline-flex" />
        <CardTitle className="text-[6.3vw] font-bold tracking-wider text-darkCharcoal md:text-[2.2vw] lg:text-[1.6vw] w-1400:text-[22px]">
          {service.title}
        </CardTitle>
      </CardHeader>
      <CardContent className="mt-[12px] text-[4.8vw] leading-[150%] text-darkCharcoal opacity-70 md:pl-[48px] md:text-[1.8vw] w-1400:text-[16px]">
